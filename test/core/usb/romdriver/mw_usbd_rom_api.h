...
{
  USBD_HW_API_T* hw; /**< Pointer to function table which exposes functions
                           which interact directly with USB device stack's core 
                           layer.*/
  USBD_CORE_API_T* core; /**< Pointer to function table which exposes functions
                           which interact directly with USB device controller 
                           hardware.*/
  USBD_MSC_API_T* msc; /**< Pointer to function table which exposes functions
                           provided by MSC function driver module.
                           */
  USBD_DFU_API_T* dfu; /**< Pointer to function table which exposes functions
                           provided by DFU function driver module.
                           */
  USBD_HID_API_T* hid; /**< Pointer to function table which exposes functions
                           provided by HID function driver module.
                           */
  USBD_CDC_API_T* cdc; /**< Pointer to function table which exposes functions
                           provided by CDC-ACM function driver module.
                           */
  uint32_t* reserved6; /**< Reserved for future function driver module.
                           */
  uint32_t version; /**< Version identifier of USB ROM stack. The version is
